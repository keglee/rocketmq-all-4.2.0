...
public class RouteInfoManager {
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                 ...
                 * 填充topicQueueTable。其实就是为默认topic自动注册路由信息，其中包括MixAll.DEFAULT_TOPIC的路由信息
                  */
                ...
                // 更新brokerLiveInfo，brokerLiveTable存放存活的Broker信息，是执行路由删除的重要依据
                ...
                // 注册Broker的过滤器Server地址列表，一个Broker会管理多个FilterServer消息过滤服务器
                // 如果broker为从节点，则需要查找该broker的master的节点信息，并更新对应的masterAddr属性
    ...
    public void scanNotActiveBroker() {
        ...
        while (it.hasNext()) {
            ...
            // 当brokerLiveInfo的lastUpdateTimestamp超过当前时间120s，NameServer则认为该Broker已不可用，则需要移除，并关闭Channel
            ...
            try {
                try {
                    ...
                    while (itBrokerAddrTable.hasNext() && (null == brokerNameFound)) {
                        ...
                        // 从BrokerData的brokerAddrs中找到具体的Broker，并移除
                        ...
                        // 如果BrokerData的brokerAddrs不存在元素了，则从brokerAddrTable中移除brokerName对应的条目
                        if (brokerData.getBrokerAddrs().isEmpty()) {
                            removeBrokerName = true;
                    ...
                    if (brokerNameFound != null && removeBrokerName) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (removed) {
                                ...
                                // 如果该集群已不包含broker，则将该集群从clusterAddrTable中移除。
